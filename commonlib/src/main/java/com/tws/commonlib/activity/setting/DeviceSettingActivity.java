 ...
 */
public class DeviceSettingActivity extends BaseActivity implements IRegisterIOTCListener {
    ...
    protected void initView() {
        ...
        ((TextView) findViewById(R.id.txt_uid)).setText(camera.uid);
    ...
    public void onResume() {
        super.onResume();
        txt_camera_name.setText(camera.getName());
    }
