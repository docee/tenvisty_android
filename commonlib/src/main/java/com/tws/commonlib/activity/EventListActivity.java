...
//        TextView txtSearchTime = (TextView) searchTimeView.findViewById(R.id.txtSearchTimeDuration);
        ...
        if (mCamera != null && mCamera.isConnected()) {
            ...
            TwsToast.showToast(EventListActivity.this, getString(R.string.toast_connect_drop));
            mIsSearchingEvent = false;
            eventListView.removeFooterView(loadingView);
            eventListView.removeFooterView(noResultView);
            eventListView.addFooterView(noResultView);
                        ...
                        if (cnt > 0) {
                            ...
                            for (int i = 0; i < cnt; i++) {
                                ...
                                if (searchEventType == event) {
                                    EventInfo evt = new EventInfo(event, time, status);
                                    //mlist.add(evt);
                                    list.add(evt);
                                }
                            }
    ...
    private void showCustomSearch() {
        ...
        final TimePickerDialog.OnTimeSetListener stopTimeOnTimeSetListener = new TimePickerDialog.OnTimeSetListener() {
            ...
            public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                ...
                //
                Calendar tmp = Calendar.getInstance();
                tmp.set(EventListActivity.this.mStopSearchCalendar.get(Calendar.YEAR), EventListActivity.this.mStopSearchCalendar.get(Calendar.MONTH),
        ...
        btnStartDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dateDialog = new DatePickerDialog(EventListActivity.this, AlertDialog.THEME_HOLO_LIGHT, startDateOnDateSetListener, cal.get(Calendar.YEAR), cal.get(Calendar.MONTH), cal
        ...
        btnStartTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Calendar cal = Calendar.getInstance();
                TimePickerDialog timeDialog = new TimePickerDialog(EventListActivity.this, AlertDialog.THEME_HOLO_LIGHT, startTimeOnTimeSetListener, cal.get(Calendar.HOUR_OF_DAY), cal.get(Calendar.MINUTE), true);
        ...
        btnStopDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Calendar cal = Calendar.getInstance();
                DatePickerDialog dateDialog = new DatePickerDialog(EventListActivity.this, AlertDialog.THEME_HOLO_LIGHT, stopDateOnDateSetListener, cal.get(Calendar.YEAR), cal.get(Calendar.MONTH), cal
                        .get(Calendar.DAY_OF_MONTH));
        ...
        btnStopTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Calendar cal = Calendar.getInstance();
                TimePickerDialog timeDialog = new TimePickerDialog(EventListActivity.this, AlertDialog.THEME_HOLO_LIGHT, stopTimeOnTimeSetListener, cal.get(Calendar.HOUR_OF_DAY), cal.get(Calendar.MINUTE), true);
