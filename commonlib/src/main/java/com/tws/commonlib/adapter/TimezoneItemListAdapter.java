...
public class TimezoneItemListAdapter extends BaseAdapter {
    ...
    public TimezoneItemListAdapter(Context context, String[] _sourceList) {
        this.mInflater = LayoutInflater.from(context);
        this.sourceList = _sourceList;
    }

    public TimezoneItemListAdapter(Context context, String[] _sourceList, int _settedPos) {
        this.mInflater = LayoutInflater.from(context);
        this.sourceList = _sourceList;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(layout == 0 ? R.layout.view_list_timezone_result : layout, null);
            holder = new ViewHolder();
            holder.txt_title = (TextView) convertView.findViewById(R.id.txt_title);
            holder.txt_gmt = (TextView) convertView.findViewById(R.id.txt_gmt);
        ...
        if (holder != null) {
            int fromIndex = sourceList[position].indexOf(')', 4);
            holder.txt_gmt.setText(sourceList[position].substring(1, fromIndex));
            holder.txt_title.setText(sourceList[position].substring(fromIndex+1));
