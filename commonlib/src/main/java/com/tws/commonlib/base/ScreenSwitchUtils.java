...
public class ScreenSwitchUtils {
            ...
            switch (msg.what) {
                case 888:
                    ...
                    if (orientation > 45 && orientation < 135) {
                        ...
                        if (isPortrait) {
                            try {
                                int screenchange = Settings.System.getInt(mActivity.getContentResolver(), Settings.System.ACCELEROMETER_ROTATION);
                                if (screenchange == 1) {
                                    L.i("test", "切换成横屏");
    ...
    private ScreenSwitchUtils(Context context) {
        L.i(TAG, "init orientation listener.");
        // 注册重力感应器,监听屏幕旋转
    ...
    public void start(Activity activity) {
        L.i(TAG, "start orientation listener.");
        mActivity = activity;
