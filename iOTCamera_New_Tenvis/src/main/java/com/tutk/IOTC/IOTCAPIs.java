...
public class IOTCAPIs {
	...
	* Please see IOTCConnectionMode for possible modes. */
	...
	/** sleeping state */
	public static final int IOTC_ER_SLEEPING					=-64;
	...
	public native static void IOTC_Setup_Session_Alive_Timeout(int Timeout_ms);
	public  native  static  int IOTC_WakeUp_WakeDevice(String pcszUID);
